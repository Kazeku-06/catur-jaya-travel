    ...
    >
      <div className="container mx-auto px-4">
                    ...
                    <div className="bg-white py-1">
                      {!isAdmin && (
                        <>
                          ...
                          <Link
                            to="/"
                            onClick={closeMenus}
                            className="flex items-center space-x-4 px-5 py-3 text-gray-600 hover:bg-gray-50 border-b border-gray-100 transition-colors"
                          >
                            <svg
                          ...
                          >
                            ...
                            <span className="font-medium">Paket Trip</span>
                          </Link>
                      ...
                      {isAdmin && (
                        <Link
                          to="/admin"
                          onClick={closeMenus}
                          className="flex items-center space-x-4 px-5 py-3 text-primary-600 hover:bg-primary-50 border-b border-gray-100 transition-colors"
                        >
                          <svg
                            className="w-5 h-5"
                            fill="none"
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              className="lg:hidden absolute top-[calc(100%+0.5rem)] left-4 right-4 bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden max-h-[calc(100vh-6rem)] flex flex-col z-[41]"
