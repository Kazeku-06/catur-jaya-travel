...
const About = () => {
  ...
  return (
    <Layout>
      ...
      {/* Hero Section */}
      <section className="relative py-24 bg-gradient-to-br from-primary-600 to-primary-800 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                ...
                alt="Our Story"
                className="w-full h-98 object-cover rounded-2xl shadow-xl"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="flex items-center p-4 bg-white hover:bg-green-50 border border-gray-100 rounded-xl shadow-sm transition-all group"
                >
                  <div className="w-12 h-12 bg-green-500 text-white rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                ...
                <a
                  ...
                  className="flex items-center p-4 bg-white hover:bg-blue-50 border border-gray-100 rounded-xl shadow-sm transition-all group"
                >
                  <div className="w-12 h-12 bg-blue-500 text-white rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                ...
                <a
                  ...
                  className="flex items-center p-4 bg-white hover:bg-purple-50 border border-gray-100 rounded-xl shadow-sm transition-all group"
                >
                  <div className="w-12 h-12 bg-purple-500 text-white rounded-full flex items-center justify-center mr-4 group-hover:scale-110 transition-transform">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207" />
                    </svg>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-gray-600">caturjayamandiri4@gmail.com</p>
                  </div>
                </a>
              </div>
            </motion.div>

            {/* Map Location - HANYA BAGIAN INI YANG DIUBAH */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
            ...
            >
              <div className="bg-white rounded-2xl p-6 shadow-lg h-full">
                ...
                {/* Map Container dengan tinggi yang lebih proporsional */}
                ...
                {/* Info Box dengan tombol Google Maps */}
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border border-blue-100">
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center mb-2">
                        ...
                        <h4 className="text-lg font-bold text-gray-900">Kantor Pusat</h4>
                      </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 ml-11">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md group"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center justify-center px-4 py-2.5 bg-white hover:bg-gray-50 text-blue-600 font-medium rounded-lg border border-blue-200 transition-all duration-200 shadow-sm hover:shadow-md group"
                    >
                      <svg className="w-4 h-4 mr-2 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
