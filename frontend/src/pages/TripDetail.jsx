          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="flex items-center text-gray-500">
                ...
                <span className="text-xs sm:text-sm">Mulai dari <span className="text-blue-500 font-bold text-base md:text-lg ml-1">{formatCurrency(trip?.price)} / trip</span></span>
              </div>
            </motion.div>
            ...
            <div className="bg-white/80 backdrop-blur-md rounded-2xl p-4 shadow-2xl border border-white/50 flex items-center justify-between sticky bottom-6 z-20">
              <div className="pl-2">
                <p className="text-xl font-black text-gray-900 leading-none">
                  {formatCurrency(trip?.price)} <span className="text-xs font-normal text-gray-400">/ trip</span>
                </p>
