      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        ...
        >
          ...
          >
            ...
            Mohon tunggu beberapa saat atau cek kembali status pembayaran Anda.
          </motion.p>
          ...
          >
            ...
            <ul className="text-sm text-blue-800 space-y-1">
              <li>• Tunggu konfirmasi pembayaran (maksimal 24 jam)</li>
              <li>• Cek email untuk update status pembayaran</li>
