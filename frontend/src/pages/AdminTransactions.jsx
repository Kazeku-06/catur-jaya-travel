    ...
    <AdminLayout>
      ...
      >
        ...
        <p className="text-gray-600">
          Kelola semua booking dan ubah status transaksi
        </p>
      </motion.div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Menampilkan {bookings.length} dari {totalItems} transaksi (5 per
                halaman)
              </p>
            </div>
            {filter !== "all" && (
              <Badge variant="info">Filter: {getStatusLabel(filter)}</Badge>
            )}
          </div>
        </div>
                    ...
                    {booking.payment_proof ? (
                      <div className="relative group">
                        <img
                          ...
                          className="w-16 h-16 object-cover border border-gray-300 rounded-lg cursor-pointer hover:opacity-90 transition-opacity"
                          onClick={() =>
                            openImageModal(
                              booking.payment_proof.image_url,
                              `Bukti Pembayaran - ${booking.id.substring(0, 8)}`,
                            )
                          }
                        />
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {selectedBooking.catalog?.title ||
                      selectedBooking.catalog?.name}
                  </p>
                </div>
                <div>
                  <span className="text-gray-600">Tipe:</span>
                  <p className="font-medium">
                    {selectedBooking.catalog_type === "trip"
                      ? "Paket Trip"
                      : "Travel"}
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {selectedBooking.booking_data?.nama_pemesan}
                  </p>
                </div>
                <div>
                  <span className="text-gray-600">Nomor HP:</span>
                  <p className="font-medium">
                    {selectedBooking.booking_data?.nomor_hp}
                  </p>
                </div>
                <div>
                  <span className="text-gray-600">Jumlah Orang:</span>
                  <p className="font-medium">
                    {selectedBooking.booking_data?.jumlah_orang} orang
                  </p>
                </div>
                <div>
                  ...
                  <p className="font-medium">
                    {formatDate(
                      selectedBooking.booking_data?.tanggal_keberangkatan,
                    )}
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {formatDate(selectedBooking.expired_at)}
                  </p>
                </div>
              </div>
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <img
                      ...
                      onClick={() =>
                        openImageModal(
                          ...
                          `Bukti Pembayaran - ${selectedBooking.id.substring(0, 8)}`,
                        )
                      }
                    />
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-600 mb-2">
                      Diupload:{" "}
                      {formatDate(selectedBooking.payment_proof.uploaded_at)}
                    </p>
