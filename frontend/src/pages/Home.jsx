...
const Home = () => {
    ...
    const handleSearch = async () => { // Validasi input
        ...
        <Layout> {/* Hero Section */}
            <section className="relative h-[70vh] flex items-center justify-center overflow-visible">
                <div className="absolute inset-0 z-0">
                    ...
                    <img src="/images/hero-mountain.jpg" alt="Beautiful Mountain View" className="w-full h-full object-cover"
                        onError={
                            (e) => {
...
{ /* Floating Search Form - Tetap Stacked tapi diperlebar ke samping */
}
<div className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 z-30 w-full max-w-2xl px-4">
    <motion.div initial={
        ...
        /* Padding horizontal (px-10) diperbesar supaya konten di dalamnya ikut melebar */
    ...
    >
        ...
        <div className="mb-5 border-b border-gray-100 pb-3">
            <div className="flex items-center">
                <svg className="w-5 h-5 mr-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {
        dateError && (
            <div className="mt-2 text-[10px] text-red-500 flex items-center font-medium">
    ...
    <Button onClick={handleSearch}
        ...
        <section className="pt-56 pb-20 bg-gray-50">
            <div className="container mx-auto px-4">
                ...
                {/* Grid System: Menjamin ukuran kartu sama persis & lurus dengan container */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full">
                    ...
                    dailyContent.map((item, index) => (
                        <motion.div key={
                            ...
                            // Menggunakan grid-cols untuk kontrol display, bukan hidden manual di className
                            className={
                                `relative h-80 w-full overflow-hidden rounded-3xl shadow-lg group cursor-pointer ${
                            ...
                            // Lebih bagus pakai whileInView untuk Home
                            viewport={
                                {once: true}
                            }
                            transition={
                            ...
                            <Link to={
                                ...
                                <img src={
                                    ...
                                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"/> {/* Overlay Gradient lebih halus */}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 md:mb-12">
                        ...
                        <div className="w-full md:w-auto">
                            <Link to="/travels">
                                <Button variant="outline" className="w-full md:w-auto border-blue-500 text-blue-500 hover:bg-blue-50 rounded-xl py-2.5 md:py-2 text-sm font-medium">
                                    Lihat Semua
                                </Button>
                            </Link>
                        </div>
